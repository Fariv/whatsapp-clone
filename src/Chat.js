        ...
        <div className="chat">
            <div className='chat__header'>
                ...
                <div className='chat__headerInfo'>
                    ...
                    <p>
                        {
                            messages[messages.length -1] ? "Last seen " + new Date(messages[messages.length -1].timestamp?.toDate()).toUTCString() : ""
                        }
                    </p>
                </div>
            ...
            <div className='chat__body'>
                {messages.map(msg => (
                    <p className={`chat__message ${msg.name === user.displayName && "chat_reciever"} `}>
